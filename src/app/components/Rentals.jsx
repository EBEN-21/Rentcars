...
const Rentals = () => {
  return (
    <div className=" mx-auto mt-20 px-2 flex items-center justify-center flex-col  ">
      <div className="flex flex-col items-center justify-center gap-5 ">
        <h1 className="max-w-[228px] bg-[#1572D31A] py-4 px-6 rounded-lg font-medium text-sm text-[#1572D3] ">
          POPULAR RENTAL DEALS
        </h1>
        <p className="font-medium text-[#333333] text-2xl sm:text-3xl text-center">
