...
const Cars = ({img, car, rating, review, passenger, doors, price }) => {
  return (
    <div className='w-[260px] flex flex-col items-center justify-between rounded-2xl shadow-xl  p-6 bg-white hover:scale-105 transition ease-in-out duration-200 '>
      
      <div className='w-full flex items-center justify-center mb-4 mt-4 '>
        <img src={img} alt={"name of car"} className='  h-[104px] object-contain' />
      </div>
