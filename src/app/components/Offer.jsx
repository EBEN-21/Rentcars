...
const Offer = () => {
  return (
    <div className='mt-20 px-4 lg:px-0 lg:pr-14 mb-12 '>
      <div className='flex flex-col lg:flex-row items-center justify-between gap-12'>

        {/* Image Section (Hidden on Small Screens) */}
        <div className='hidden lg:block relative w-[520px]  overflow-hidden animate__animated animate__fadeInUp'>
        ...
        {/* Content Section */}
        <div className='flex flex-col gap-8 w-full lg:max-w-[540px] items-center text-center lg:text-left'>
          ...
          <div className='flex flex-col gap-3 items-center lg:items-start'>
            ...
            <p className='font-medium text-[#333333] text-2xl sm:text-3xl leading-snug'>
