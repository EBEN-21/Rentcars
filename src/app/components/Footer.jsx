...
const Footer = () => {
  return (
    <div className=' lg:px-14 mt-2 lg:mt-0 px-3 pt-8 lg:pt-9 flex flex-col items-center justify-between bg-[#051C34] '>
        ...
        <div className='flex flex-col lg:flex-row items-start justify-between w-full gap-10 '>
            ...
            <div className='flex flex-col items-start gap-8 max-w-[195px] '>
                <div className='flex items-center gap-2'>
                    <img src="/footer/logo.svg" width={20} alt="logo pic" />
                    <h1 className='font-bold text-white text-base '>RENTCARS</h1>
                </div>

                <ul className='flex flex-col text-[#D6D6D6] text-sm font-normal gap-5'>
                ...
                {/* links */}
            <div>
                <div className=' w-full flex items-start justify-between lg:gap-24 gap-10 flex-col lg:flex-row'> 
                {/* product */}
                <div className='flex flex-col items-start gap-5 max-w-[140px] '>
                ...
                <div className='flex flex-col items-start gap-5 max-w-[140px]'>
                    ...
                    <ul className='flex  text-[#D6D6D6]  gap-4 mt-5'>
                        <li>
                            <img src="/footer/facebook.svg" alt="" width={20} />
                        </li>
                        <li>
                            <img src="/footer/instagram.svg" alt="" width={20} />
                        </li>
                        <li>
                            <img src="/footer/youtube.svg" alt="" width={20} />
                        </li>
                    </ul>
                </div>
            </div>
