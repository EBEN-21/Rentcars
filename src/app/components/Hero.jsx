...
const Hero = () => {
  return (
    <div className='relative mt-10 '>
      ...
      <div className='flex items-center overflow-hidden justify-between lg:pl-24 px-10  '>
        <div className='lg:max-w-[400px] w-full relative z-10 flex flex-col text-center lg:text-left  '>
            <h1 className='font-semibold text-5xl mb-7'>Find, book and rent a car <span className='text-[#1572D3] '>Easily</span> </h1>
            <img src='/images/under.svg' className='hidden lg:block absolute top-24 right-4' />
            <p className='font-normal text-lg text-[#272727] leading-normal '>Get a car wherever and whenever you need it with your IOS and Android device.</p>
        ...
        <form className="bg-white w-full shadow-lg p-4 rounded-lg flex flex-col lg:flex-row items-center justify-between gap-4">
          ...
          <div className="w-full lg:w-auto md:ml-8 flex items-center gap-2">
            ...
            <div className="flex flex-col">
              <p className="pt-1 px-2 font-medium text-[#3E3E3E] text-base">Location</p>
              <input
                type="text"
          ...
          <div className="w-full lg:w-auto flex items-center gap-2 border-t md:border-t-0 md:border-l-2 border-[#ACACAC] md:px-4 pt-4 md:pt-0">
            ...
            <div className="flex flex-col">
              <p className="pt-1 px-2 font-medium text-[#3E3E3E] text-base">Pickup Date</p>
              <input
                type="text"
          ...
          <div className="w-full lg:w-auto flex items-center gap-2 border-t md:border-t-0 md:border-l-2 border-[#ACACAC] md:px-4 pt-4 md:pt-0">
            ...
            <div className="flex flex-col">
              <p className="pt-1 px-2 font-medium text-[#3E3E3E] text-base">Return Date</p>
              <input
                type="text"
                placeholder="Tues 15 Feb, 10:00"
                className="px-2 py-1 w-full md:w-[180px] text-black text-[14px] font-normal placeholder:text-[#ACACAC]"
