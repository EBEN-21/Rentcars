    ...
    <div className="w-full flex justify-center py-12 px-4 sm:px-6 ">
      ...
      >
        {testimonials.map((testimonial, index) => (
          <SwiperSlide key={index} className="!w-full sm:!w-[540px] md:!w-[720px] flex justify-center">
            <div className="bg-white rounded-2xl shadow-lg p-8 md:pl-0 md:py-0 flex flex-col md:flex-row items-center gap-6">
              ...
              <div className="w-full md:w-1/2 flex flex-col gap-4 text-left">
                <div className="flex flex-col">
                  <h3 className="text-3xl font-semibold">{testimonial.rating}.0 <span className="text-gray-500 text-sm">stars</span></h3>
                  <span className="text-yellow-500 text-xl">★ ★ ★ ★ ★</span>
                  
                </div>
                <p className="text-gray-700 my-2 md:my-7 text-lg">{testimonial.text}</p>
                <div>
